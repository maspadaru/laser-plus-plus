...
TEST(DiamondTest, DiamondAtom) {
    ...
    expected[10] = "10 -> q(x10, y10, z10), q(x8, y8, z8), q(x6, y6, z6)";
    expected[11] = "11 -> q(x10, y10, z10), q(x8, y8, z8), q(x6, y6, z6), "
        "u(Z, Z), u(a11, a11), u(-9.099, -9.099)";
    expected[12] = "12 -> q(x10, y10, z10), q(x8, y8, z8), q(x6, y6, z6), "
        "u(Z, Z), u(a11, a11), u(-9.099, -9.099)";
    expected[13] = "13 -> q(x10, y10, z10), q(x8, y8, z8), q(x6, y6, z6), "
        "u(Z, Z), u(a11, a11), u(-9.099, -9.099)";
    expected[14] = "14 -> q(x10, y10, z10), q(x8, y8, z8), q(x6, y6, z6), "
        "u(Z, Z), u(a11, a11), u(-9.099, -9.099)";
